  ...
  return (
    ...
    >
      <motion.div
        ...
        className="modal__content scrollbar-hide relative mt-16 h-fit max-h-[84vh] w-fit max-w-[98vw] overflow-y-scroll rounded-2xl bg-gray-300 px-6 py-6 text-center shadow-themeShadow backdrop-blur-md sm:py-10"
