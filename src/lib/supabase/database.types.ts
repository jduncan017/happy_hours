...
export type Database = {
  ...
  public: {
    Tables: {
      deals: {
        Row: {
          ...
          days_applied: Database["public"]["Enums"]["day_of_week"][]
          description: string
          id: string
      ...
      edit_suggestions: {
        ...
        Relationships: [
          {
            foreignKeyName: "edit_suggestions_restaurant_id_fkey"
            columns: ["restaurant_id"]
            isOneToOne: false
            referencedRelation: "restaurants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_avatar_url: {
        Args: { user_id: string; size?: string }
        Returns: string
      }
      get_proj4_from_srid: {
        Args: { "": number }
      ...
      insert_restaurant_with_coordinates: {
        Args: {
          p_name: string
          p_address: string
          p_area: string
          p_cuisine_type: string
          p_price_category: string
          p_lng: number
          p_lat: number
          p_website?: string
          p_hero_image?: string
      ...
      restaurants_within_radius: {
        ...
        Returns: {
          ...
          area: string
          cuisine_type: string
          price_category: Database["public"]["Enums"]["price_category"]
          website: string
          menu_url: string
          hero_image: string
          images: string[]
      ...
      update_restaurant_coordinates: {
        Args: { restaurant_id: string; lng: number; lat: number }
        Returns: undefined
      }
      updategeometrysrid: {
        Args: {
